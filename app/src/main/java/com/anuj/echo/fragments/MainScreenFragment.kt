...
import com.anuj.echo.adapters.MainScreenAdapter
import java.util.*
...
class MainScreenFragment : Fragment() {
    ...
    fun bottomBar_ClickHandler() {
        nowPlayingButtonBar?.setOnClickListener({
            Statified.meediaPlayer = SongPlayingFragment.Statified.mediaplayer
            val songPlaying_Fragment = SongPlayingFragment()
            var args = Bundle()
            ...
            songPlaying_Fragment.arguments = args
            fragmentManager.beginTransaction()
                    .replace(R.id.details_fragment, songPlaying_Fragment)
