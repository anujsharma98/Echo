...
import com.anuj.echo.CurrentSongHelper
...
class SongPlayingFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (fromFavBottomBar != null) {
            Statified.mediaplayer = FavouriteFragment.Statified.mMediaPlayer
        } else if (fromMainScreenBottomBar != null) {
            Statified.mediaplayer = MainScreenFragment.Statified.meediaPlayer
        } else {
